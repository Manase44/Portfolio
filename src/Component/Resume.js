...
const Resume = () => {
  const [school, setSchool] = useState([
    ...
    {
      id: "sc2",
      institution: "Gede High School",
      course: "Kenya Certificate of Secondary Education",
      duration: "2017 - 2020",
    },
    {
      id: "sc3",
      institution: "Galana Ranch Primary School",
  ...
  const [certificates, setCertificate] = useState([
    {
      ...
      from: "Teach2Give",
      image: "/certs/Manase Gunga Karisa-01.jpg",
    },
    {
      id: "cert1",
      title: "Basics of Operating Systems",
      from: "Cisco Skills for All",
      image: "/certs/Operating_Systems_Basics.png",
    },
    {
      id: "cert2",
      title: "Introduction to Data Science",
      from: "Cisco Skills for All",
      image: "/certs/Introduction_to_Data_Science.png",
    },
    {
      id: "cert3",
      title: "Introduction to JavaScript",
      from: "Wild Learner",
      image: "/certs/certificate_1684759100718.jpg",
    },
  ]);

  const [skills, setSkill] = useState([
    { name: "Node.js", percentage: 90, id: "sk1", tech: "backend" },
    { name: "Django", percentage: 40, id: "sk9", tech: "backend" },
    { name: "React", percentage: 90, id: "sk2", tech: "frontend" },
    { name: "Next.js", percentage: 75, id: "sk10", tech: "frontend" },
    ...
    { name: "MongoDB", percentage: 80, id: "sk7", tech: "database" },
    { name: "PostgreSQL", percentage: 70, id: "sk8", tech: "database" },
  ]);
        ...
        <div className="row">
          <div className="col pt-3" id="contentColumn">
                ...
                {jobs.map((job) => (
                  <div key={job.id} className="p-2" id="job">
                    ...
                    <div className="d-flex gap-2">
                      <img src="/teach2give-logo.jpeg" width={20} height={20} />
                      <p>{job.company}</p>
                    </div>
            ...
            <div className="row ms-3 my-2">
              <p id="subtitle">
                Skills <i className="fa-solid fa-user-gear"></i>
              </p>
            ...
            <div
              className="row mt-2 mb-4 d-flex justify-content-center"
              id="download"
            >
