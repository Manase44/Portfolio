      ...
      <div className="row w-auto h-100">
        <div id="overall" className="col h-100 p-0">
          ...
          <div className="row" id="contentDiv">
            ...
            <div
              id="textDiv"
              className="col-md-5 col-lg-7 text-center text-md-start"
            >
              <div id="name">
                <h1>Manase Gunga</h1>
              ...
              <div id="links" className="ms-3 mt-3">
                <a
                  href="https://github.com/Manase44"
                  title="Github"
                  className="me-2"
                  rel="noreferrer"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/manase-gunga-37a3612ab/"
                  title="LinkedIn"
                  className="me-2"
                  rel="noreferrer"
                  target="_blank"
